...
const st = StyleSheet.create({
  ...
  proyCard: { backgroundColor: '#fff', borderRadius: BorderRadius.md, paddingHorizontal: 14, paddingVertical: 12, marginBottom: 8, flexDirection: 'row', alignItems: 'center', boxShadow: '0px 1px 4px rgba(0, 0, 0, 0.04)', elevation: 2 },
